...
import com.myservice.MyCalculatorService_Service;
...
public class CalculatorServlet extends HttpServlet {
    ...
    @WebServiceRef(wsdlLocation = "WEB-INF/wsdl/localhost_8080/fiyo/MyCalculatorService.wsdl")
    private MyCalculatorService_Service service;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            num2=Double.parseDouble(request.getParameter("number1"));
    ...
    private double addition(double num1, double num2) {
        ...
        com.myservice.MyCalculatorService port = service.getMyCalculatorServicePort();
